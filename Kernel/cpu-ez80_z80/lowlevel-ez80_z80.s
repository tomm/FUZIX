...
;.include "../cpu-z80/lowlevel-z80.s"
;
; This now copies code from ../cpu-z80/lowlevel-z80.s, with the only change (maybe)
; being interrupt_handler returning with 'ret', not 'reti'. This is because there
; is an ADL-mode (24-bit) interrupt handler calling interrupt_handler(), which does
; the actual reti.
...
.endif
	ld hl, #intret
	push hl
	ret			; We have now 'left' the interrupt
